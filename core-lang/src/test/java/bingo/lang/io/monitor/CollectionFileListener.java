...
/**
 * {@link FileChangeListener} implementation that adds created, changed and deleted
 * files/directories to a set of {@link Collection}s.
 */
class CollectionFileListener implements FileChangeListener, Serializable {

    private static final long serialVersionUID = -1223822999514703503L;
