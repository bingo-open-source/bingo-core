...
public class EnumerableTest extends TestCase {
	...
	public void testEnumerable() {
		...
		Assert.assertEquals(5, Enumerable.range(1, 5).size());
	...
	private static Enumerable<Character> chars(String value) {
		return chars(value.toCharArray());
	}

	private static Enumerable<Character> chars(char[] chars) {
