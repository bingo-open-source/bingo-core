...
import bingo.lang.resource.AbstractResource;
import bingo.lang.resource.ByteArrayResource;
import bingo.lang.resource.ClassPathResource;
import bingo.lang.resource.FileSystemResource;
import bingo.lang.resource.InputStreamResource;
import bingo.lang.resource.Resource;
import bingo.lang.resource.UrlResource;
...
public class ResourceTests {
	...
	public void testByteArrayResource() throws IOException {
		...
		String content = IO.toString(new InputStreamReader(resource.getInputStream()));
	...
	public void testClassPathResource() throws IOException {
		Resource resource = new ClassPathResource("bingo/lang/resource/Resource.class");
		doTestResource(resource);
		Resource resource2 = new ClassPathResource("bingo/lang/../lang/resource/./Resource.class");
		assertEquals(resource, resource2);
		Resource resource3 = new ClassPathResource("bingo/lang/").createRelative("../lang/resource/./Resource.class");
	...
	public void testClassPathResourceWithClassLoader() throws IOException {
		Resource resource =
				new ClassPathResource("bingo/lang/resource/Resource.class", getClass().getClassLoader());
		doTestResource(resource);
		assertEquals(resource,
				new ClassPathResource("bingo/lang/../lang/resource/./Resource.class", getClass().getClassLoader()));
	}
	...
	public void testFileSystemResource() throws IOException {
		...
		Resource resource2 = new FileSystemResource("lang/resource/Resource.class");
		assertEquals(resource2, new FileSystemResource("core/../lang/resource/./Resource.class"));
	}
	...
	private void doTestResource(Resource resource) throws IOException {
		...
		Resource relative2 = resource.createRelative("./ResourcePatternResolver.class");
