...
import bingo.lang.Java.Version;
...
public class Sys {
    ...
    private static final Version JAVA_SPECIFICATION_VERSION_AS_ENUM = Version.get(JAVA_SPECIFICATION_VERSION);
     ...
     */
    public static boolean isJavaVersionAtLeast(Version requiredVersion) {
