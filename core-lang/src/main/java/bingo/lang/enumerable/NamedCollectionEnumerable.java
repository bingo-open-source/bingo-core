...
public class NamedCollectionEnumerable<E extends Named> extends CollectionEnumerable<E> implements NamedEnumerable<E> {

	public NamedCollectionEnumerable() {
	    super();
    }

	public NamedCollectionEnumerable(Collection<E> collection) {
	    super(collection);
    }
