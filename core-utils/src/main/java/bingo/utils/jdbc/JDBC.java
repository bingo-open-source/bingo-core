...
import bingo.lang.exceptions.WrappedSQLException;
...
public final class JDBC {
    ...
    public static <T> T execute(DataSource ds,JdbcCallbackWithResult<T> callback) throws WrappedSQLException {
    ...
    public static <T> T execute(Connection connection,JdbcCallbackWithResult<T> callback) throws WrappedSQLException {
        try{
            return callback.executeWithResult(connection);
        }catch(SQLException e) {
            throw new WrappedSQLException(e);
