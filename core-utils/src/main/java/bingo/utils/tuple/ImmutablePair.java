 ...
 * objects are stored in the pair, then the pair itself effectively becomes mutable. The class is also not {@code final}
 * , so a subclass could add undesirable behaviour.
 * </p>
 * 
 * <p>
