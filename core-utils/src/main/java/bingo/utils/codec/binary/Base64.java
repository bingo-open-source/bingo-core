...
public class Base64 {
	 ...
	 */	
	public static String encode(byte[] data, boolean isChunked) {
		if (null == data) {
			return Strings.EMPTY;
		}
	 ...
	 */
	public static byte[] encodeToBytes(byte[] data, boolean isChunked) {
		if (null == data) {
			return Arrays.EMPTY_BYTE_ARRAY;
		}
	...
	public static byte[] decode(byte[] base64Bytes) {
		...
		byte[] decodes = Base64MiGImpl.decode(base64Bytes);
