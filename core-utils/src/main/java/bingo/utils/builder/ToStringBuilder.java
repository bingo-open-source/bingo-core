...
public class ToStringBuilder implements Builder<String> {
	...
	public ToStringBuilder appendAsObjectToString(Object object) {
		Objects.identityToString(object, this.getStringBuffer());
		return this;
	}
	 ...
	 * 
	 *                                                                  public String toString() {
	 * 	                                                                 return new ToStringBuilder(this).appendToString(delegate.toString()).append(
	 * 	                                                                         fieldInThisClass).toString();
	 *                                                                  }
	 * </pre>
	 * 
	 * <p>
	...
	/**
	 * Returns the String that was build as an object representation. The default implementation utilizes the
