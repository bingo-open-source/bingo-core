 ...
 * 
 * <p>
 * This class is intended to be used as a singleton. There is no need to instantiate a new style each time. Simply
 * instantiate the class once, customize the values as required, and store the result in a public static final variable
...
public class StandardToStringStyle extends ToStringStyle {
	...
	/**
	 * <p>
	 * Sets the start text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is
	 * output.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * Gets the end text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is
	 * output.</p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Sets the end text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is
	 * output.
	 * </p>
	 * 
	 * <p>
