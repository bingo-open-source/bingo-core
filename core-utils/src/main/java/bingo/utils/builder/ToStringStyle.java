...
import bingo.utils.Classes;
import bingo.utils.Objects;

/**
 * <p>
 * Controls <code>String</code> formatting for {@link ToStringBuilder}. The main public interface is always via
 * <code>ToStringBuilder</code>.
 * </p>
 * 
 * <p>
 * These classes are intended to be used as <code>Singletons</code>. There is no need to instantiate a new style each
 * time. A program will generally use one of the predefined constants on this class. Alternatively, the
 * {@link StandardToStringStyle} class can be used to set the individual settings. Thus most styles can be achieved
 * without subclassing.
 * </p>
 * 
 * <p>
 * If required, a subclass can override as many or as few of the methods as it requires. Each object type (from
 * <code>boolean</code> to <code>long</code> to <code>Object</code> to <code>int[]</code>) has its own methods to output
 * it. Most have two versions, detail and summary.
 * 
 * <p>
 * For example, the detail version of the array based methods will output the whole array, whereas the summary method
 * will just output the array length.
 * </p>
 * 
 * <p>
...
public abstract class ToStringStyle implements Serializable {
	...
	/**
	 * The multi line toString style. Using the Using the <code>Person</code> example from {@link ToStringBuilder}, the
	 * output would look like this:
	 * 
	 * <pre>
	 * Person@182f0db[
	...
	protected void appendCyclicObject(StringBuffer buffer, String fieldName, Object value) {
		Objects.identityToString(value, buffer);
	}
	...
	private static final class MultiLineToStringStyle extends ToStringStyle {
		...
		MultiLineToStringStyle() {
			super();
			this.setContentStart("[");
			this.setFieldSeparator(Sys.LINE_SEPARATOR + "  ");
			this.setFieldSeparatorAtStart(true);
			this.setContentEnd(Sys.LINE_SEPARATOR + "]");
		}
